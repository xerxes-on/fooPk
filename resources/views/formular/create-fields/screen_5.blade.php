        ...
        <div class="form-group{{ $_question->required ? ' required' : '' }} range_sports_outer">
            <div class="range_sports_item {{ $_question->key_code . '_' . $_question->id }}">
                ...
                <div class="select_wrap">
                    ...
                    <span class="time-count">{{ trans('survey_questions.timesper') }}</span>
                </div>
                <div class="select_wrap">
                    <span class="time-count right">{{ trans('survey_questions.each') }} </span>
                    ...
                    <span class="time-count">{{ trans('survey_questions.minuten') }}</span>
                </div>
            </div>
        </div>
    @endforeach
