    ...
    <div v-if="dataUrl"
      ...
      <div class="avatar-cropper-container">
        ...
        <div class="avatar-cropper-footer">
          <button class="avatar-cropper-btn" @click.stop.prevent="cancel">{{ labels.cancel }}</button>

          <button class="avatar-cropper-btn" @click.stop.prevent="submit">{{ labels.submit }}</button>
        </div>
      </div>
    </div>
