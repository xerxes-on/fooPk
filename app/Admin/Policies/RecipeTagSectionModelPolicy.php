...
final class RecipeTagSectionModelPolicy
{
    ...
    {
        return $admin->hasPermissionTo(PermissionEnum::SEE_RECIPE_TAGS->value);
    }

    public function create(Admin $admin): bool
    {
        return $admin->hasPermissionTo(PermissionEnum::CREATE_RECIPE_TAGS->value);
    }
