<div class="alert bg-info">
    ...
    <div class="form-group input-group">
        <input type="text"
               ...
               id="ingredient_tag_search_input"
               name="search_name"
               placeholder="@lang('admin.ingredient_tag.type_title_of_ingredient_tag')"
        >
        <span class="input-group-btn">
			<button class="btn btn-primary" id="ingredient_tag_search" type="button">@lang('common.search')
				<i style="display: none;margin-left: 5px;" class="fa fa-spinner fa-spin search-request-spinner"></i>
			</button>
            <button class="btn btn-danger" id="clear_search" type="button" style="display: none;"
