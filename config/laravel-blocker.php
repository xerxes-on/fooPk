...
return [
    ...
    */
    'malicious_urls' => env(
        'AI_BLOCKER_MALICIOUS_URLS',
        'wp-admin|wp-login|wp-config|wp-content|'.
        'call_user_func_array|invokefunction|/vendor|config|php' .
        '.git|.env|install.php|.aspx|.sql'.
        '|aws|_ignition|sitemap|well-known'
    ),// debug - can harm debugBar assets, ads - can harm working directories (e.g. uploads)
    ...
    |
    */
    'malicious_user_agents' => env('AI_BLOCKER_MALICIOUS_USER_AGENTS', 'dotbot|linguee|zgrab'),
