...
mix.js(`${paths.modules.admin.js}/admin.js`,
	...
	.js(`${paths.modules.admin.js}/client/client-edit.js`, `${paths.dest.js}/admin/client`)
	.js(`${paths.modules.admin.js}/client/client-display.js`, `${paths.dest.js}/admin/client`)
